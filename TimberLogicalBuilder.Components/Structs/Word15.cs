  ...
  ISignalSource b14)
{
  ...
  public static Word15 FromArray(ISignalSource[] bits)
  {
    if(bits.Length != 15) throw new ArgumentException();
    return new Word15(
      bits[0], bits[1], bits[2],  bits[3],  bits[4],  bits[5],  bits[6],  bits[7],
      bits[8], bits[9], bits[10], bits[11], bits[12], bits[13], bits[14]);
  }
  
  public static ISignalSource[] FlattenBitPlanes(Word15[] words)
  {
